 ...
 object AJSResourcesSpec extends Specification {
  ...
  "AngularJS Resource Snippet" should {
    "with FoBo.AJSResources.injectJS?resources=angular,angular-animate produce (in order) angular.js, angular-animate.js toserve script tags" in {
      ...
      val res1 = """<script src="/classpath/fobo/angular.js" type="text/javascript"/><script src="/classpath/fobo/angular-animate.js" type="text/javascript"/>""";
      val res2 = """<script src="/classpath/fobo/angular.js" type="text/javascript"></script><script src="/classpath/fobo/angular-animate.js" type="text/javascript"></script>""";

      val m = collection.immutable.HashMap("resources" -> "angular,angular-animate") 
      val out = 
    ...
    "with FoBo.AJSResources.injectJS?resources=angular,angular only produce one toserve script tag, angular.js" in {
      ...
      val res1 = """<script src="/classpath/fobo/angular.js" type="text/javascript"/>""";
      val res2 = """<script src="/classpath/fobo/angular.js" type="text/javascript"></script>""";
    ...
    "with FoBo.AJSResources.injectCSS?resources=a,b,c,d produce in order ,a.css, b.css, c.css, d.css toserve css link tags" in {
      ...
      val res1 = """<link href="/classpath/fobo/a.css" rel="stylesheet" type="text/css"/><link href="/classpath/fobo/b.css" rel="stylesheet" type="text/css"/><link href="/classpath/fobo/c.css" rel="stylesheet" type="text/css"/><link href="/classpath/fobo/d.css" rel="stylesheet" type="text/css"/>"""; 
      val res2 = """<link href="/classpath/fobo/a.css" rel="stylesheet" type="text/css"></link><link href="/classpath/fobo/b.css" rel="stylesheet" type="text/css"></link><link href="/classpath/fobo/c.css" rel="stylesheet" type="text/css"></link><link href="/classpath/fobo/d.css" rel="stylesheet" type="text/css"></link>"""; 
