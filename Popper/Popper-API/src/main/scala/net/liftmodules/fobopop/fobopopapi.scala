...
/**
  ...
  *
  */
package object fobopopapi {

  override def toString() = fobopopapi.API.toString()
  ...
  object API extends API {
    ...
    override def toString() = "fobopopapi.API = " + store.toString()
  ...
  private object FoBoAPI {
    lazy val init: Unit = {
      LiftRules.addToPackages("net.liftmodules.fobopop")
    }
  }
