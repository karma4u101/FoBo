...
/**
  ...
  * @since v1.1
  */
trait BootstrapMegaMetaProtoUser[ModelType <: MegaProtoUser[ModelType]]
  ...
  /**
    ...
    * override lift's corresponding key value. If the key is present but the value is empty it will render empty.
    */
  def resLoginLabelPassword: NodeSeq =
    S.loc("fobo.ProtoUser.Login.label.password",
  ...
  /**
    ...
    * override lift's corresponding key value. If the key is present but the value is empty it will render empty.
    */
  def resLostPasswordLabelUserName: NodeSeq =
    S.loc("fobo.ProtoUser.LostPassword.label.userName",
  ...
  /**
    ...
    * override lift's corresponding key value. If the key is present but the value is empty it will render empty.
    */
  def resChangePasswordLabelOldPassword =
    S.loc("fobo.ProtoUser.ChangePassword.label.old.password",
  ...
  /**
    ...
    * override lift's corresponding key value. If the key is present but the value is empty it will render empty.
    */
  def resChangePasswordLabelNewPassword =
    S.loc("fobo.ProtoUser.ChangePassword.label.new.password",
  ...
  /**
    ...
    * override lift's corresponding key value. If the key is present but the value is empty it will render empty.
    */
  def resChangePasswordLabelRepeatPassword =
    S.loc("fobo.ProtoUser.ChangePassword.label.repeat.password",
          scala.xml.Text(S.?("repeat.password")))
  ...
  override def changePassword = {
    ...
    val bind = {
      ...
      ".old-password" #> SHtml.password("", s => oldPassword = s) &
        ...
        "type=submit" #> myChangePasswordSubmitButton(
          resChangePasswordSubmitChange,
          testAndSet _)
    }
