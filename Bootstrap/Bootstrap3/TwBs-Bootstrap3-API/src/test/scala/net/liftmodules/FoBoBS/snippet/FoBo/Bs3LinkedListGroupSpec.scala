...
object Bs3LinkedListGroupSpec
    extends WebSpec(Bs3LinkedListGroupSpecBoot.boot _) {
  "Bs3LinkedListGroupSpec Specification".title

  val html1 =
    <div data-lift="FoBo.Bs3LinkedListGroup.builder?group=lg1"></div>;
...
//    }
    ...
    "Produce a (Bootstrap3) linked list group that link's to self" withSFor (testUrl1) in {
      ...
      object Bs3LinkedListGroup extends Bs3LinkedListGroup //{ override def linkToSelf = true}
