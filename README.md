...
A **live demo** and introduction to using the FoBo module(s), including [Scaladoc documentation](http://www.media4u101.se/fobo-lift-template-demo/foboapi/index.html#net.liftmodules.FoBo.package) 
