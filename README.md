...
The module includes a evolving API that includes helper object:s and snippet:s (see API documents for usage) that will take care of some common toolkit and component usage and initiation, bootstrap menu builders, script generation and more. 
