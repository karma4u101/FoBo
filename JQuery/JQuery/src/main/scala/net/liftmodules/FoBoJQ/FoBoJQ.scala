...
//  }
  ...
  @deprecated(
    "Init no longer nessesary as it is now automaticaly done for respective FoBoJQ.InitParam",
    "1.6.0")
  def init() {}
  ...
  /**
    *
    */
  @deprecated("Use FoBoJQ.Toolkit.Init=FoBoJQ.Toolkit.[Toolkit Object]",
              "1.6.0")
  ...
  /**
    ...
    * @since v1.3
    */
  @deprecated("Use FoBoJQ.Toolkit.Init=FoBoJQ.Toolkit.JQueryMigrate121",
              "1.6.0")
